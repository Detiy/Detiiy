...
export default {
  data() {
    ...
    return {
      delicacy: [
        {
          view: require("../../assets/image/YX1.jpg"),
          title: "吃货烤串",
          number: 4.5,
          count: 1314,
          Fprice: 35,
        ...
        {
          view: require("../../assets/image/YX2.jpg"),
          title: "炸鸡啤酒",
          number: 4.3,
          count: 1314,
          Fprice: 30,
        ...
        {
          view: require("../../assets/image/YX3.jpg"),
          title: "海鲜排挡",
          number: 4.6,
          count: 1314,
          Fprice: 60,
        ...
        {
          view: require("../../assets/image/YX4.jpg"),
          title: "龙虾",
          number: 4.5,
          count: 1314,
          Fprice: 100,
        ...
        {
          view: require("../../assets/image/YX5.jpg"),
          title: "蟹煲",
          number: 4.7,
          count: 1314,
          Fprice: 80,
