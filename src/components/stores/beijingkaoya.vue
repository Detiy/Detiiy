...
export default {
  data() {
    ...
    return {
      delicacy: [
        {
          view: require("../../assets/image/BJKY1.jpg"),
          title: "北京烤鸭第一",
          number: 4.5,
          count: 1314,
          Fprice: 35,
        ...
        {
          view: require("../../assets/image/BJKY2.jpg"),
          title: "北京烤鸭第二",
          number: 4.3,
          count: 1314,
          Fprice: 30,
        ...
        {
          view: require("../../assets/image/BJKY3.jpg"),
          title: "北京烤鸭第三",
          number: 4.6,
          count: 1314,
          Fprice: 60,
        ...
        {
          view: require("../../assets/image/BJKY4.jpg"),
          title: "北京烤鸭第四",
          number: 4.5,
          count: 1314,
          Fprice: 100,
        ...
        {
          view: require("../../assets/image/BJKY5.jpg"),
          title: "北京烤鸭第五",
          number: 4.7,
          count: 1314,
          Fprice: 80,
