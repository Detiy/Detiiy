...
export default {
  data() {
    ...
    return {
      delicacy: [
        {
          view: require("../../assets/image/HB1.jpg"),
          title: "鸡腿汉堡",
          number: 4.5,
          count: 1314,
          Fprice: 35,
        ...
        {
          view: require("../../assets/image/HB2.jpg"),
          title: "牛肉汉堡",
          number: 4.3,
          count: 1314,
          Fprice: 30,
        ...
        {
          view: require("../../assets/image/HB3.jpg"),
          title: "双层汉堡",
          number: 4.6,
          count: 1314,
          Fprice: 60,
        ...
        {
          view: require("../../assets/image/HB4.jpg"),
          title: "鲜虾汉堡",
          number: 4.5,
          count: 1314,
          Fprice: 100,
        ...
        {
          view: require("../../assets/image/HB5.jpg"),
          title: "鸡排汉堡",
          number: 4.7,
          count: 1314,
          Fprice: 80,
