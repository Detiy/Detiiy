...
export default {
  data() {
    ...
    return {
      delicacy: [
        {
          view: require("../../assets/image/MHQX1.jpg"),
          title: "满汉全席1",
          number: 4.5,
          count: 1314,
          Fprice: 35,
        ...
        {
          view: require("../../assets/image/MHQX2.jpg"),
          title: "满汉全席2",
          number: 4.3,
          count: 1314,
          Fprice: 30,
        ...
        {
          view: require("../../assets/image/MHQX3.jpg"),
          title: "满汉全席3",
          number: 4.6,
          count: 1314,
          Fprice: 60,
        ...
        {
          view: require("../../assets/image/MHQX4.jpg"),
          title: "满汉全席4",
          number: 4.5,
          count: 1314,
          Fprice: 100,
        ...
        {
          view: require("../../assets/image/MHQX5.jpg"),
          title: "满汉全席5",
          number: 4.7,
          count: 1314,
          Fprice: 80,
