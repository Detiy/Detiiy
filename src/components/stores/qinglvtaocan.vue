...
export default {
  data() {
    ...
    return {
      delicacy: [
        {
          view: require("../../assets/image/QLTC1.jpg"),
          title: "情侣套餐第一",
          number: 4.5,
          count: 1314,
          Fprice: 35,
        ...
        {
          view: require("../../assets/image/QLTC2.jpg"),
          title: "情侣套餐第二",
          number: 4.3,
          count: 1314,
          Fprice: 30,
        ...
        {
          view: require("../../assets/image/QLTC3.jpg"),
          title: "情侣套餐第三",
          number: 4.6,
          count: 1314,
          Fprice: 60,
        ...
        {
          view: require("../../assets/image/QLTC4.jpg"),
          title: "情侣套餐第四",
          number: 4.5,
          count: 1314,
          Fprice: 100,
        ...
        {
          view: require("../../assets/image/QLTC5.jpg"),
          title: "情侣套餐第五",
          number: 4.7,
          count: 1314,
          Fprice: 80,
