...
export default {
  data() {
    ...
    return {
      delicacy: [
        {
          view: require("../../assets/image/WEL1.jpg"),
          title: "饿了1",
          number: 4.5,
          count: 1314,
          Fprice: 35,
        ...
        {
          view: require("../../assets/image/WEL2.jpg"),
          title: "饿了2",
          number: 4.3,
          count: 1314,
          Fprice: 30,
        ...
        {
          view: require("../../assets/image/WEL3.jpg"),
          title: "饿了3",
          number: 4.6,
          count: 1314,
          Fprice: 60,
        ...
        {
          view: require("../../assets/image/WEL4.jpg"),
          title: "饿了4",
          number: 4.5,
          count: 1314,
          Fprice: 100,
        ...
        {
          view: require("../../assets/image/WEL5.jpg"),
          title: "饿了5",
          number: 4.7,
          count: 1314,
          Fprice: 80,
