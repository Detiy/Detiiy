...
export default {
  data() {
    ...
    return {
      delicacy: [
        {
          view: require("../../assets/image/SG1.jpg"),
          title: "香蕉",
          number: 4.5,
          count: 1314,
          Fprice: 35,
        ...
        {
          view: require("../../assets/image/SG2.jpg"),
          title: "苹果",
          number: 4.3,
          count: 1314,
          Fprice: 30,
        ...
        {
          view: require("../../assets/image/SG3.jpg"),
          title: "葡萄",
          number: 4.6,
          count: 1314,
          Fprice: 60,
        ...
        {
          view: require("../../assets/image/SG4.jpg"),
          title: "火龙果",
          number: 4.5,
          count: 1314,
          Fprice: 100,
        ...
        {
          view: require("../../assets/image/SG5.jpg"),
          title: "哈密瓜",
          number: 4.7,
          count: 1314,
          Fprice: 80,
