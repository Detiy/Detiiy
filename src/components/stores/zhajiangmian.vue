...
export default {
  data() {
    ...
    return {
      delicacy: [
        {
          view: require("../../assets/image/ZJM1.jpg"),
          title: "炸酱面第一",
          number: 4.5,
          count: 1314,
          Fprice: 35,
        ...
        {
          view: require("../../assets/image/ZJM2.jpg"),
          title: "炸酱面第二",
          number: 4.3,
          count: 1314,
          Fprice: 30,
        ...
        {
          view: require("../../assets/image/ZJM3.jpg"),
          title: "炸酱面第三",
          number: 4.6,
          count: 1314,
          Fprice: 60,
        ...
        {
          view: require("../../assets/image/ZJM4.jpg"),
          title: "炸酱面第四",
          number: 4.5,
          count: 1314,
          Fprice: 100,
        ...
        {
          view: require("../../assets/image/ZJM5.jpg"),
          title: "炸酱面第五",
          number: 4.7,
          count: 1314,
          Fprice: 80,
